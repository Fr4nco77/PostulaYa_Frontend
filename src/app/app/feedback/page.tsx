...
export default function Feedback() {
  ...
  return (
    <main className="flex w-full flex-col items-start gap-6 md:flex-row lg:max-w-3xl xl:max-w-4xl">
      <div className="flex flex-col items-center gap-2 rounded-lg bg-slate-100 p-3 shadow-xl">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-slate-900">
            Apóyanos
          </h1>
          <p className="mt-3 text-lg leading-relaxed font-bold text-slate-700 sm:text-xl">
